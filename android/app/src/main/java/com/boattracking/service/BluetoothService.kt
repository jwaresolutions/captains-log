package com.boattracking.service
...
import com.boattracking.bluetooth.BluetoothManager
import com.boattracking.bluetooth.SensorData
import com.boattracking.network.ApiService
import com.boattracking.network.models.CreateSensorReadingRequest
...
class BluetoothService : Service() {
     ...
     */
    fun getConnectionState(): StateFlow<com.boattracking.bluetooth.BluetoothConnectionState> {
     ...
     */
    fun getDiscoveredDevices(): StateFlow<List<com.boattracking.bluetooth.BluetoothDevice>> {
     ...
     */
    fun getPairedDevices(): StateFlow<List<com.boattracking.bluetooth.BluetoothDevice>> {
